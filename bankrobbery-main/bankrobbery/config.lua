...
-- Police Settings:
Config.PoliceJobs = {"police", "lspd", "fbi"}	-- Jobs that can't do bankrobberies etc, but can secure the banks.
-- Alert Blip
...
Config.Safe_Cash = {dirty_cash = true, amount = {min = 200, max = 500}, multiplier = 1000}	-- Read the README for instructions.

Config.Safe_Items = {
	[1] = { item = "goldbar", chance = 65, min = 1, max = 3},
	[2] = { item = "goldwatch", chance = 85, min = 15, max = 20},
	[3] = { item = "goldnecklace", chance = 40, min = 10, max = 14},
	[4] = { item = "diamond", chance = 25, min = 0, max = 3},
}
...
Config.Bank_Safes = {
	...
	[23] = { pos = {315.2691,-288.2983,54.1431}, 	anim_pos = {314.4778,-288.1304,54.1431,253.56}, 	robbed = false, failed = false },
	...
	-- Fleeca Bank (Burton):
	[26] = { pos = {-354.3059,-57.70284,49.0148}, 	anim_pos = {-353.4183,-57.87337,49.01482,68.58}, 	robbed = true, failed = false },
